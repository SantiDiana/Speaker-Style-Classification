...
if __name__=='__main__':
    ...
    for a in range(150,700,50):
        ...
        # np.savetxt('accuracies_NUS/accuracies_sung/vector'+str(i),vector_accuracies)
        # leng=len(vector_accuracies)
        # vector_accuracies=[]
        # print('Pasamos al siguiente')

    np.savetxt('vector_indices_thresholds.txt',vector_indices_thresholds)
    ...
    for i in range(1,14):
        ...
        vector=np.loadtxt('accuracies_NUS/accuracies_sung/vector'+str(i))
