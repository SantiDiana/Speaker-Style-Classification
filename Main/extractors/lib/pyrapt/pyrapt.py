...
import extractors.lib.pyrapt.raptparams
import extractors.lib.pyrapt.nccfparams
...
def _setup_rapt_params(kwargs):
    ...
    params = extractors.lib.pyrapt.raptparams.Raptparams()
...
def _get_nccf_params(audio_input, raptparams, is_firstpass):
    ...
    """
    nccfparam = extractors.lib.pyrapt.nccfparams.Nccfparams()
